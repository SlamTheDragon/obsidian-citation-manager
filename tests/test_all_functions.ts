...
import { PDFScanner } from '../src/backend/indexing/pdfScanner';
import { DOIResolver } from '../src/backend/resolvers/doiResolver';
import { ArxivResolver } from '../src/backend/resolvers/arxivResolver';
import { ISBNResolver } from '../src/backend/resolvers/isbnResolver';
import { URLResolver } from '../src/backend/resolvers/urlResolver';
import { BibTeXResolver } from '../src/backend/resolvers/bibtexResolver';
import { ReferenceMetadata, ProjectRecord, CitationManagerSettings } from '../src/backend/types';
